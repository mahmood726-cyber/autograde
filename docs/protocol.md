        # Autograde: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/autograde.git

        ## Objective

        AutoGRADE automates GRADE evidence certainty assessment, translating systematic review findings into structured certainty profiles using predefined domain-specific rules.
        ...
        - Code: https://github.com/mahmood726-cyber/autograde.git
